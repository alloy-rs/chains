...
impl NamedChain {
    ...
    const fn index(self) -> ChainIndex {
        match self {
            ...
            Self::OpBNBTestnet => 99,
            Self::MegaEthTestnet => 100,
            Self::Zeta => 101,
            Self::Canto => 102,
            Self::Kaia => 103,
            Self::Base => 104,
            Self::EvmosTestnet => 105,
            Self::Evmos => 106,
            Self::Plasma => 107,
            Self::PlasmaTestnet => 108,
            Self::MonadTestnet => 109,
            Self::Chiado => 110,
            Self::AbstractTestnet => 111,
            Self::Cannon => 112,
            Self::Immutable => 113,
            Self::ImmutableTestnet => 114,
            Self::GravityAlphaTestnetSepolia => 115,
            Self::SignetPecorino => 116,
            Self::SonicTestnet => 117,
            Self::Holesky => 118,
            Self::FluentDevnet => 119,
            Self::FluentTestnet => 120,
            Self::Fluent => 121,
            Self::Oasis => 122,
            Self::TempoDevnet => 123,
            Self::AnvilHardhat => 124,
            Self::Curtis => 125,
            Self::ApeChain => 126,
            Self::Mode => 127,
            Self::LensTestnet => 128,
            Self::Arbitrum => 129,
            Self::ArbitrumNova => 130,
            Self::Celo => 131,
            Self::EmeraldTestnet => 132,
            Self::Emerald => 133,
            Self::TempoTestnet => 134,
            Self::TempoModerato => 135,
            Self::Etherlink => 136,
            Self::AvalancheFuji => 137,
            Self::Avalanche => 138,
            Self::Formicarium => 139,
            Self::Insectarium => 140,
            Self::RobinhoodTestnet => 141,
            Self::Sophon => 142,
            Self::Superposition => 143,
            Self::Ink => 144,
            Self::PgnSepolia => 145,
            Self::LineaGoerli => 146,
            Self::LineaSepolia => 147,
            Self::Linea => 148,
            Self::Bob => 149,
            Self::Treasure => 150,
            Self::RadiusTestnet => 151,
            Self::PolygonAmoy => 152,
            Self::BerachainBepolia => 153,
            Self::Berachain => 154,
            Self::Blast => 155,
            Self::BaseGoerli => 156,
            Self::BaseSepolia => 157,
            Self::Plume => 158,
            Self::PlumeTestnet => 159,
            Self::SuperpositionTestnet => 160,
            Self::Gravity => 161,
            Self::EtherlinkShadownet => 162,
            Self::Taiko => 163,
            Self::TaikoHekla => 164,
            Self::Bitlayer => 165,
            Self::RoninTestnet => 166,
            Self::FilecoinCalibrationTestnet => 167,
            Self::ArbitrumTestnet => 168,
            Self::ArbitrumGoerli => 169,
            Self::ArbitrumSepolia => 170,
            Self::SyndrSepolia => 171,
            Self::AutonomysNovaTestnet => 172,
            Self::ScrollSepolia => 173,
            Self::Scroll => 174,
            Self::Hoodi => 175,
            Self::Xai => 176,
            Self::PharosTestnet => 177,
            Self::Radius => 178,
            Self::Katana => 179,
            Self::InkSepolia => 180,
            Self::BobSepolia => 181,
            Self::Odyssey => 182,
            Self::TreasureTopaz => 183,
            Self::ArcTestnet => 184,
            Self::Zora => 185,
            Self::CeloSepolia => 186,
            Self::Sepolia => 187,
            Self::OptimismSepolia => 188,
            Self::Corn => 189,
            Self::CornTestnet => 190,
            Self::BlastSepolia => 191,
            Self::SkaleBaseSepoliaTestnet => 192,
            Self::PolkadotTestnet => 193,
            Self::Kusama => 194,
            Self::Polkadot => 195,
            Self::SophonTestnet => 196,
            Self::Degen => 197,
            Self::ZoraSepolia => 198,
            Self::SkaleBase => 199,
            Self::Aurora => 200,
            Self::AuroraTestnet => 201,
            Self::XaiSepolia => 202,
        }
    }
...
static NATIVE_CURRENCY_SYMBOLS: [&str; 65] = [
    ...
    "USD", "M", "IOTX", "MNT", "ZETA", "KAIA", "XPL", "IMX", "tIMX", "USDS", "APE", "GRASS",
    "CELO", "XTZ", "tM", "SOPH", "MAGIC", "RUSD", "BERA", "PLUME", "XAI", "PHRS", "USDC", "BTCN",
    "PAS", "KSM", "DOT", "DEGEN",
];

static ETHERSCAN_API_URLS: [&str; 162] = [
...
static ETHERSCAN_BASE_URLS: [&str; 165] = [
    "https://etherscan.io",
...
static CHAIN_DATA: [ChainData; 203] = {
    ...
    [
        ...
        d(99, 9, 76, 76, 0, 1000, S | T | O, W),
        d(100, 0, 77, 77, 0, 1000, S | T, W),
        d(101, 41, 78, 78, 8, 6000, 0, 20),
        d(102, N, N, N, 1, 5700, 0, W),
        d(103, 42, 79, 79, 9, 1000, 0, 21),
        d(104, 0, 80, 80, 0, 2000, S | O, 1),
        d(105, N, N, N, N, 1900, T, W),
        d(106, N, N, N, N, 1900, 0, W),
        d(107, 43, 81, 81, 0, 1000, 0, W),
        d(108, 43, 82, 82, 0, 1000, T, W),
        d(109, 13, 83, 83, 0, 400, S | T, W),
        d(110, N, 84, 84, N, 5000, S, W),
        d(111, N, 85, 85, 0, 1000, T | X, W),
        d(112, N, N, N, N, 0, S | T, W),
        d(113, 44, 86, 86, 1, 2000, S, W),
        d(114, 45, 87, 87, 1, 2000, S | T, W),
        d(115, 32, 88, 88, N, 260, S | T, W),
        d(116, 46, 89, 89, 1, 12000, S | T, W),
        d(117, 14, 90, 90, 0, 1000, T, W),
        d(118, 0, 91, 91, 0, 0, S | T | E, W),
        d(119, N, 92, 92, N, 3000, S | T, W),
        d(120, N, 93, 93, N, 1000, S | T, W),
        d(121, N, 94, 94, N, 1000, 0, W),
        d(122, N, N, N, N, 5500, 0, W),
        d(123, 37, 69, 95, N, 500, S | T | TP, W),
        d(124, N, N, N, N, 200, S | T, W),
        d(125, 47, 95, 96, 1, 260, S | T, W),
        d(126, 47, 96, 97, 0, 260, S, 22),
        d(127, N, 97, 98, 1, 2000, S | O, W),
        d(128, 48, 98, 99, N, 1000, T | X, W),
        d(129, 0, 99, 100, 0, 260, S | A, 23),
        d(130, 0, 100, 101, 0, 260, S | A, W),
        d(131, 49, 101, 102, 0, 1000, S | O, W),
        d(132, N, 102, 103, N, 0, L | T, W),
        d(133, N, 103, 104, N, 6000, L, W),
        d(134, 37, 69, 105, N, 500, S | T | TP, W),
        d(135, 37, 69, 106, N, 500, S | T | TP, W),
        d(136, 50, 104, 107, 1, 5000, S, W),
        d(137, N, 105, 108, 0, 2000, S | T, W),
        d(138, N, 106, 109, 0, 2000, S, 24),
        d(139, 51, 107, 110, 0, 7000, S | T, 17),
        d(140, 51, 108, 111, N, 7000, S | T, 17),
        d(141, 0, 109, 112, N, 400, S | T | A, W),
        d(142, 52, 110, 113, 0, 1000, L | X, 25),
        d(143, 0, 111, 114, 1, 260, S, 26),
        d(144, 0, 112, 115, 1, 1000, S | O, W),
        d(145, N, N, N, 1, 2000, T | O, W),
        d(146, N, N, N, N, 2000, T, W),
        d(147, N, 113, 116, 0, 2000, T, W),
        d(148, 0, 114, 117, 0, 2000, S, 27),
        d(149, 0, 115, 118, N, 2000, S, W),
        d(150, 53, N, N, N, 0, L, 28),
        d(151, 54, 116, 119, N, 500, S | T, W),
        d(152, 12, 117, 120, 0, 2100, T, W),
        d(153, 55, 118, 121, 10, 2000, S | T, W),
        d(154, 55, 119, 122, 10, 2000, S, 29),
        d(155, N, 120, 123, 0, 2000, S, 30),
        d(156, 0, N, N, 0, 2000, S | T | O, W),
        d(157, 0, 121, 124, 0, 2000, S | T | O, W),
        d(158, 56, 122, 125, N, 260, S, W),
        d(159, 56, 123, 126, N, 260, S | T, W),
        d(160, 0, 124, 127, 1, 260, S | T, W),
        d(161, 32, 125, 128, N, 260, S, W),
        d(162, 50, 126, 129, 1, 5000, S | T, W),
        d(163, 0, 127, 130, 0, 12000, S, 31),
        d(164, 0, 128, 131, 0, 12000, S | T, W),
        d(165, 36, 129, 132, 11, 3000, 0, 32),
        d(166, 35, 130, 133, N, 3000, S | T | O, W),
        d(167, N, 131, 134, N, 30000, T, W),
        d(168, N, N, N, 0, 260, T | A, W),
        d(169, N, N, N, 0, 260, T | A, W),
        d(170, N, 132, 135, 0, 260, S | T | A, W),
        d(171, N, 133, 136, 0, 260, S | T, W),
        d(172, N, N, N, N, 1000, S | T, W),
        d(173, 0, 134, 137, 0, 3000, S | T, W),
        d(174, 0, 135, 138, 0, 3000, S, 33),
        d(175, N, 136, 139, 0, 0, S | T, W),
        d(176, 57, 137, 140, 0, 260, S, W),
        d(177, 58, N, N, N, 1000, S | T, W),
        d(178, 54, 138, 141, N, 500, S, W),
        d(179, 0, 139, 142, 0, 1000, S | O, W),
        d(180, N, 140, 143, 1, 1000, S | T | O, W),
        d(181, N, 141, 144, N, 2000, S | T, W),
        d(182, N, 142, 145, N, 1000, S | T | O, W),
        d(183, 53, N, N, N, 0, L | T, W),
        d(184, 59, 143, 146, 1, 500, S | T, W),
        d(185, N, 144, 147, 1, 2000, O, W),
        d(186, 49, 145, 148, 1, 1000, S | T, W),
        d(187, 0, 146, 149, 0, 0, S | T | E, W),
        d(188, 0, 147, 150, 0, 2000, S | T | O, W),
        d(189, 60, 148, 151, 2, 0, S, W),
        d(190, 60, 149, 152, 2, 0, S | T, W),
        d(191, N, 150, 153, 0, 2000, S | T | O, W),
        d(192, N, 151, 154, 1, 1000, T, W),
        d(193, 61, 152, 155, 1, 2000, S | T, W),
        d(194, 62, 153, 156, 1, 2000, S, W),
        d(195, 63, 154, 157, 1, 2000, S, W),
        d(196, 52, 155, 158, 0, 1000, L | T | X, W),
        d(197, 64, 156, 159, N, 600, 0, W),
        d(198, N, 157, 160, 1, 2000, S | T | O, W),
        d(199, N, 158, 161, 1, 1000, 0, W),
        d(200, N, 159, 162, 0, 1100, 0, W),
        d(201, N, 160, 163, 0, 1100, T, W),
        d(202, 57, 161, 164, 0, 260, S | T, W),
    ]
};
