...
static CHAIN_DATA: [ChainData; 201] = {
    ...
    [
        ...
        d(79, 33, N, 60, N, 1000, S, W),
        d(80, 29, 60, 61, 1, 700, S, W),
        d(81, N, 61, 62, 1, 2000, S | O, W),
        d(82, N, 62, 63, 1, 2000, S | T | O, W),
        d(83, 34, 63, 64, N, 3000, 0, W),
        d(84, 22, 64, 65, 0, 700, S | T, W),
        d(85, N, 65, 66, 0, 2000, S | T | O, W),
        d(86, 0, 66, 67, 0, 1000, X, 15),
        d(87, N, N, N, 3, 1200, L | T, W),
        d(88, 35, 67, 68, 7, 3000, 0, 16),
        d(89, 36, 68, 69, N, 500, S | TP, W),
        d(90, 0, 69, 70, 0, 1000, S, W),
        d(91, 37, 70, 71, 0, 7000, S, 17),
        d(92, 0, 71, 72, N, 400, S | A, W),
        d(93, 38, N, N, N, 5000, S, 18),
        d(94, 20, 72, 73, 1, 2000, S | T | O, W),
        d(95, 39, 73, 74, 0, 2000, S, 19),
        d(96, 39, 74, 75, 0, 2000, S | T, W),
        d(97, 9, 75, 76, 0, 1000, S | T | O, W),
        d(98, 0, 76, 77, 0, 1000, S | T, W),
        d(99, 40, 77, 78, 8, 6000, 0, 20),
        d(100, N, N, N, 1, 5700, 0, W),
        d(101, 41, 78, 79, 9, 1000, 0, 21),
        d(102, 0, 79, 80, 0, 2000, S | O, 1),
        d(103, N, N, N, N, 1900, T, W),
        d(104, N, N, N, N, 1900, 0, W),
        d(105, 42, 80, 81, 0, 1000, 0, W),
        d(106, 42, 81, 82, 0, 1000, T, W),
        d(107, 13, 82, 83, 0, 400, S | T, W),
        d(108, N, 83, 84, N, 5000, S, W),
        d(109, N, 84, 85, 0, 1000, T | X, W),
        d(110, N, N, N, N, 0, S | T, W),
        d(111, 43, 85, 86, 1, 2000, S, W),
        d(112, 44, 86, 87, 1, 2000, S | T, W),
        d(113, 32, 87, 88, N, 260, S | T, W),
        d(114, 45, 88, 89, 1, 12000, S | T, W),
        d(115, 14, 89, 90, 0, 1000, T, W),
        d(116, 0, 90, 91, 0, 0, S | T | E, W),
        d(117, N, 91, 92, N, 3000, S | T, W),
        d(118, N, 92, 93, N, 1000, S | T, W),
        d(119, N, 93, 94, N, 1000, 0, W),
        d(120, N, N, N, N, 5500, 0, W),
        d(121, 36, N, N, N, 500, S | T | TP, W),
        d(122, N, N, N, N, 200, S | T, W),
        d(123, 46, 94, 95, 1, 260, S | T, W),
        d(124, 46, 95, 96, 0, 260, S, 22),
        d(125, N, 96, 97, 1, 2000, S | O, W),
        d(126, 47, 97, 98, N, 1000, T | X, W),
        d(127, 0, 98, 99, 0, 260, S | A, 23),
        d(128, 0, 99, 100, 0, 260, S | A, W),
        d(129, 48, 100, 101, 0, 1000, S | O, W),
        d(130, N, 101, 102, N, 0, L | T, W),
        d(131, N, 102, 103, N, 6000, L, W),
        d(132, 36, 68, 104, N, 500, S | T | TP, W),
        d(133, 36, 68, 105, N, 500, S | T | TP, W),
        d(134, 49, 103, 106, 1, 5000, S, W),
        d(135, N, 104, 107, 0, 2000, S | T, W),
        d(136, N, 105, 108, 0, 2000, S, 24),
        d(137, 50, 106, 109, 0, 7000, S | T, 17),
        d(138, 50, 107, 110, N, 7000, S | T, 17),
        d(139, 0, 108, 111, N, 400, S | T | A, W),
        d(140, 51, 109, 112, 0, 1000, L | X, 25),
        d(141, 0, 110, 113, 1, 260, S, 26),
        d(142, 0, 111, 114, 1, 1000, S | O, W),
        d(143, N, N, N, 1, 2000, T | O, W),
        d(144, N, N, N, N, 2000, T, W),
        d(145, N, 112, 115, 0, 2000, T, W),
        d(146, 0, 113, 116, 0, 2000, S, 27),
        d(147, 0, 114, 117, N, 2000, S, W),
        d(148, 52, N, N, N, 0, L, 28),
        d(149, 53, 115, 118, N, 500, S | T, W),
        d(150, 12, 116, 119, 0, 2100, T, W),
        d(151, 54, 117, 120, 10, 2000, S | T, W),
        d(152, 54, 118, 121, 10, 2000, S, 29),
        d(153, N, 119, 122, 0, 2000, S, 30),
        d(154, 0, N, N, 0, 2000, S | T | O, W),
        d(155, 0, 120, 123, 0, 2000, S | T | O, W),
        d(156, 55, 121, 124, N, 260, S, W),
        d(157, 55, 122, 125, N, 260, S | T, W),
        d(158, 0, 123, 126, 1, 260, S | T, W),
        d(159, 32, 124, 127, N, 260, S, W),
        d(160, 49, 125, 128, 1, 5000, S | T, W),
        d(161, 0, 126, 129, 0, 12000, S, 31),
        d(162, 0, 127, 130, 0, 12000, S | T, W),
        d(163, 35, 128, 131, 11, 3000, 0, 32),
        d(164, 34, 129, 132, N, 3000, T, W),
        d(165, N, 130, 133, N, 30000, T, W),
        d(166, N, N, N, 0, 260, T | A, W),
        d(167, N, N, N, 0, 260, T | A, W),
        d(168, N, 131, 134, 0, 260, S | T | A, W),
        d(169, N, 132, 135, 0, 260, S | T, W),
        d(170, N, N, N, N, 1000, S | T, W),
        d(171, 0, 133, 136, 0, 3000, S | T, W),
        d(172, 0, 134, 137, 0, 3000, S, 33),
        d(173, N, 135, 138, 0, 0, S | T, W),
        d(174, 56, 136, 139, 0, 260, S, W),
        d(175, 57, N, 140, N, 1000, S | T, W),
        d(176, 53, 137, 141, N, 500, S, W),
        d(177, 0, 138, 142, 0, 1000, S | O, W),
        d(178, N, 139, 143, 1, 1000, S | T | O, W),
        d(179, N, 140, 144, N, 2000, S | T, W),
        d(180, N, 141, 145, N, 1000, S | T | O, W),
        d(181, 52, N, N, N, 0, L | T, W),
        d(182, 58, 142, 146, 1, 500, S | T, W),
        d(183, N, 143, 147, 1, 2000, O, W),
        d(184, 48, 144, 148, 1, 1000, S | T, W),
        d(185, 0, 145, 149, 0, 0, S | T | E, W),
        d(186, 0, 146, 150, 0, 2000, S | T | O, W),
        d(187, 59, 147, 151, 2, 0, S, W),
        d(188, 59, 148, 152, 2, 0, S | T, W),
        d(189, N, 149, 153, 0, 2000, S | T | O, W),
        d(190, N, 150, 154, 1, 1000, T, W),
        d(191, 60, 151, 155, 1, 2000, S | T, W),
        d(192, 61, 152, 156, 1, 2000, S, W),
        d(193, 62, 153, 157, 1, 2000, S, W),
        d(194, 51, 154, 158, 0, 1000, L | T | X, W),
        d(195, 63, 155, 159, N, 600, 0, W),
        d(196, N, 156, 160, 1, 2000, S | T | O, W),
        d(197, N, 157, 161, 1, 1000, 0, W),
        d(198, N, 158, 162, 0, 1100, 0, W),
        d(199, N, 159, 163, 0, 1100, T, W),
        d(200, 56, 160, 164, 0, 260, S | T, W),
    ]
};
