...
impl NamedChain {
    ...
    const fn index(self) -> ChainIndex {
        match self {
            ...
            Self::Robinhood => 91,
            Self::Iotex => 92,
            Self::WorldSepolia => 93,
            Self::Mantle => 94,
            Self::MantleSepolia => 95,
            Self::OpBNBTestnet => 96,
            Self::MegaEthTestnet => 97,
            Self::Zeta => 98,
            Self::Canto => 99,
            Self::Kaia => 100,
            Self::Base => 101,
            Self::EvmosTestnet => 102,
            Self::Evmos => 103,
            Self::Plasma => 104,
            Self::PlasmaTestnet => 105,
            Self::MonadTestnet => 106,
            Self::Chiado => 107,
            Self::AbstractTestnet => 108,
            Self::Cannon => 109,
            Self::Immutable => 110,
            Self::ImmutableTestnet => 111,
            Self::GravityAlphaTestnetSepolia => 112,
            Self::SignetPecorino => 113,
            Self::SonicTestnet => 114,
            Self::Holesky => 115,
            Self::FluentDevnet => 116,
            Self::FluentTestnet => 117,
            Self::Fluent => 118,
            Self::Oasis => 119,
            Self::TempoDevnet => 120,
            Self::AnvilHardhat => 121,
            Self::Curtis => 122,
            Self::ApeChain => 123,
            Self::Mode => 124,
            Self::LensTestnet => 125,
            Self::Arbitrum => 126,
            Self::ArbitrumNova => 127,
            Self::Celo => 128,
            Self::EmeraldTestnet => 129,
            Self::Emerald => 130,
            Self::TempoTestnet => 131,
            Self::TempoModerato => 132,
            Self::Etherlink => 133,
            Self::AvalancheFuji => 134,
            Self::Avalanche => 135,
            Self::Formicarium => 136,
            Self::Insectarium => 137,
            Self::RobinhoodTestnet => 138,
            Self::Sophon => 139,
            Self::Superposition => 140,
            Self::Ink => 141,
            Self::PgnSepolia => 142,
            Self::LineaGoerli => 143,
            Self::LineaSepolia => 144,
            Self::Linea => 145,
            Self::Bob => 146,
            Self::Treasure => 147,
            Self::RadiusTestnet => 148,
            Self::PolygonAmoy => 149,
            Self::BerachainBepolia => 150,
            Self::Berachain => 151,
            Self::Blast => 152,
            Self::BaseGoerli => 153,
            Self::BaseSepolia => 154,
            Self::Plume => 155,
            Self::PlumeTestnet => 156,
            Self::SuperpositionTestnet => 157,
            Self::Gravity => 158,
            ...
            Self::BobSepolia => 177,
            Self::Odyssey => 178,
            Self::TreasureTopaz => 179,
            Self::ArcTestnet => 180,
            Self::Zora => 181,
            Self::CeloSepolia => 182,
            Self::Sepolia => 183,
            Self::OptimismSepolia => 184,
            Self::Corn => 185,
            Self::CornTestnet => 186,
            Self::BlastSepolia => 187,
            Self::SkaleBaseSepoliaTestnet => 188,
            Self::PolkadotTestnet => 189,
            Self::Kusama => 190,
            Self::Polkadot => 191,
            Self::SophonTestnet => 192,
            Self::Degen => 193,
            Self::ZoraSepolia => 194,
            Self::SkaleBase => 195,
            Self::Aurora => 196,
            Self::AuroraTestnet => 197,
            Self::XaiSepolia => 198,
        }
    }
...
static CHAIN_DATA: [ChainData; 199] = {
    ...
    [
        ...
        d(91, 0, 71, 71, N, 400, S | A, W),
        d(92, 37, N, N, N, 5000, S, 18),
        d(93, 20, 72, 72, 1, 2000, S | T | O, W),
        d(94, 38, 73, 73, 0, 2000, S, 19),
        d(95, 38, 74, 74, 0, 2000, S | T, W),
        d(96, 9, 75, 75, 0, 1000, S | T | O, W),
        d(97, 0, 76, 76, 0, 1000, S | T, W),
        d(98, 39, 77, 77, 8, 6000, 0, 20),
        d(99, N, N, N, 1, 5700, 0, W),
        d(100, 40, 78, 78, 9, 1000, 0, 21),
        d(101, 0, 79, 79, 0, 2000, S | O, 1),
        d(102, N, N, N, N, 1900, T, W),
        d(103, N, N, N, N, 1900, 0, W),
        d(104, 41, 80, 80, 0, 1000, 0, W),
        d(105, 41, 81, 81, 0, 1000, T, W),
        d(106, 13, 82, 82, 0, 400, S | T, W),
        d(107, N, 83, 83, N, 5000, S, W),
        d(108, N, 84, 84, 0, 1000, T | X, W),
        d(109, N, N, N, N, 0, S | T, W),
        d(110, 42, 85, 85, 1, 2000, S, W),
        d(111, 43, 86, 86, 1, 2000, S | T, W),
        d(112, 32, 87, 87, N, 260, S | T, W),
        d(113, 44, 88, 88, 1, 12000, S | T, W),
        d(114, 14, 89, 89, 0, 1000, T, W),
        d(115, 0, 90, 90, 0, 0, S | T | E, W),
        d(116, N, 91, 91, N, 3000, S | T, W),
        d(117, N, 92, 92, N, 1000, S | T, W),
        d(118, N, 93, 93, N, 1000, 0, W),
        d(119, N, N, N, N, 5500, 0, W),
        d(120, 35, N, N, N, 500, S | T | TP, W),
        d(121, N, N, N, N, 200, S | T, W),
        d(122, 45, 94, 94, 1, 260, S | T, W),
        d(123, 45, 95, 95, 0, 260, S, 22),
        d(124, N, 96, 96, 1, 2000, S | O, W),
        d(125, 46, 97, 97, N, 1000, T | X, W),
        d(126, 0, 98, 98, 0, 260, S | A, 23),
        d(127, 0, 99, 99, 0, 260, S | A, W),
        d(128, 47, 100, 100, 0, 1000, S | O, W),
        d(129, N, 101, 101, N, 0, L | T, W),
        d(130, N, 102, 102, N, 6000, L, W),
        d(131, 35, 68, 103, N, 500, S | T | TP, W),
        d(132, 35, 68, 104, N, 500, S | T | TP, W),
        d(133, 48, 103, 105, 1, 5000, S, W),
        d(134, N, 104, 106, 0, 2000, S | T, W),
        d(135, N, 105, 107, 0, 2000, S, 24),
        d(136, 49, 106, 108, 0, 7000, S | T, 17),
        d(137, 49, 107, 109, N, 7000, S | T, 17),
        d(138, 0, 108, 110, N, 400, S | T | A, W),
        d(139, 50, 109, 111, 0, 1000, L | X, 25),
        d(140, 0, 110, 112, 1, 260, S, 26),
        d(141, 0, 111, 113, 1, 1000, S | O, W),
        d(142, N, N, N, 1, 2000, T | O, W),
        d(143, N, N, N, N, 2000, T, W),
        d(144, N, 112, 114, 0, 2000, T, W),
        d(145, 0, 113, 115, 0, 2000, S, 27),
        d(146, 0, 114, 116, N, 2000, S, W),
        d(147, 51, N, N, N, 0, L, 28),
        d(148, 52, 115, 117, N, 500, S | T, W),
        d(149, 12, 116, 118, 0, 2100, T, W),
        d(150, 53, 117, 119, 10, 2000, S | T, W),
        d(151, 53, 118, 120, 10, 2000, S, 29),
        d(152, N, 119, 121, 0, 2000, S, 30),
        d(153, 0, N, N, 0, 2000, S | T | O, W),
        d(154, 0, 120, 122, 0, 2000, S | T | O, W),
        d(155, 54, 121, 123, N, 260, S, W),
        d(156, 54, 122, 124, N, 260, S | T, W),
        d(157, 0, 123, 125, 1, 260, S | T, W),
        d(158, 32, 124, 126, N, 260, S, W),
        d(159, 48, 125, 127, 1, 5000, S | T, W),
        d(160, 0, 126, 128, 0, 12000, S, 31),
        d(161, 0, 127, 129, 0, 12000, S | T, W),
        d(162, 34, 128, 130, 11, 3000, 0, 32),
        d(163, 33, 129, 131, N, 3000, T, W),
        d(164, N, 130, 132, N, 30000, T, W),
        d(165, N, N, N, 0, 260, T | A, W),
        d(166, N, N, N, 0, 260, T | A, W),
        d(167, N, 131, 133, 0, 260, S | T | A, W),
        d(168, N, 132, 134, 0, 260, S | T, W),
        d(169, N, N, N, N, 1000, S | T, W),
        d(170, 0, 133, 135, 0, 3000, S | T, W),
        d(171, 0, 134, 136, 0, 3000, S, 33),
        d(172, N, 135, 137, 0, 0, S | T, W),
        d(173, 55, 136, 138, 0, 260, S, W),
        d(174, 52, 137, 139, N, 500, S, W),
        d(175, 0, 138, 140, 0, 1000, S | O, W),
        d(176, N, 139, 141, 1, 1000, S | T | O, W),
        d(177, N, 140, 142, N, 2000, S | T, W),
        d(178, N, 141, 143, N, 1000, S | T | O, W),
        d(179, 51, N, N, N, 0, L | T, W),
        d(180, 56, 142, 144, 1, 500, S | T, W),
        d(181, N, 143, 145, 1, 2000, O, W),
        d(182, 47, 144, 146, 1, 1000, S | T, W),
        d(183, 0, 145, 147, 0, 0, S | T | E, W),
        d(184, 0, 146, 148, 0, 2000, S | T | O, W),
        d(185, 57, 147, 149, 2, 0, S, W),
        d(186, 57, 148, 150, 2, 0, S | T, W),
        d(187, N, 149, 151, 0, 2000, S | T | O, W),
        d(188, N, 150, 152, 1, 1000, T, W),
        d(189, 58, 151, 153, 1, 2000, S | T, W),
        d(190, 59, 152, 154, 1, 2000, S, W),
        d(191, 60, 153, 155, 1, 2000, S, W),
        d(192, 50, 154, 156, 0, 1000, L | T | X, W),
        d(193, 61, 155, 157, N, 600, 0, W),
        d(194, N, 156, 158, 1, 2000, S | T | O, W),
        d(195, N, 157, 159, 1, 1000, 0, W),
        d(196, N, 158, 160, 0, 1100, 0, W),
        d(197, N, 159, 161, 0, 1100, T, W),
        d(198, 55, 160, 162, 0, 260, S | T, W),
    ]
};
