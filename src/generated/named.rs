...
static CHAIN_DATA: [ChainData; 201] = {
    ...
    [
        ...
        d(164, 34, 129, 132, N, 3000, S | T | O, W),
        ...
        d(176, 53, 137, 140, N, 500, S, W),
        d(177, 0, 138, 141, 0, 1000, S | O, W),
        d(178, N, 139, 142, 1, 1000, S | T | O, W),
        d(179, N, 140, 143, N, 2000, S | T, W),
        d(180, N, 141, 144, N, 1000, S | T | O, W),
        d(181, 52, N, N, N, 0, L | T, W),
        d(182, 58, 142, 145, 1, 500, S | T, W),
        d(183, N, 143, 146, 1, 2000, O, W),
        d(184, 48, 144, 147, 1, 1000, S | T, W),
        d(185, 0, 145, 148, 0, 0, S | T | E, W),
        d(186, 0, 146, 149, 0, 2000, S | T | O, W),
        d(187, 59, 147, 150, 2, 0, S, W),
        d(188, 59, 148, 151, 2, 0, S | T, W),
        d(189, N, 149, 152, 0, 2000, S | T | O, W),
        d(190, N, 150, 153, 1, 1000, T, W),
        d(191, 60, 151, 154, 1, 2000, S | T, W),
        d(192, 61, 152, 155, 1, 2000, S, W),
        d(193, 62, 153, 156, 1, 2000, S, W),
        d(194, 51, 154, 157, 0, 1000, L | T | X, W),
        d(195, 63, 155, 158, N, 600, 0, W),
        d(196, N, 156, 159, 1, 2000, S | T | O, W),
        d(197, N, 157, 160, 1, 1000, 0, W),
        d(198, N, 158, 161, 0, 1100, 0, W),
        d(199, N, 159, 162, 0, 1100, T, W),
        d(200, 56, 160, 163, 0, 260, S | T, W),
    ]
};
