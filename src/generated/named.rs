...
static NATIVE_CURRENCY_SYMBOLS: [&str; 64] = [
    ...
    "M", "IOTX", "MNT", "USDC", "ZETA", "KAIA", "XPL", "IMX", "tIMX", "USDS", "APE", "GRASS",
    "CELO", "XTZ", "tM", "SOPH", "MAGIC", "RUSD", "BERA", "PLUME", "XAI", "PHRS", "BTCN", "PAS",
    "KSM", "DOT", "DEGEN",
];
...
static CHAIN_DATA: [ChainData; 203] = {
    ...
    [
        ...
        d(135, 36, 68, 106, N, 500, S | T | TP, W),
        ...
        d(165, 35, 129, 132, 11, 3000, 0, 32),
        d(166, 34, 130, 133, N, 3000, S | T | O, W),
