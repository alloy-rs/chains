...
impl NamedChain {
    ...
    const fn index(self) -> ChainIndex {
        match self {
            ...
            Self::Injective => 81,
            Self::Soneium => 82,
            Self::WhitechainSepolia => 83,
            Self::SoneiumMinatoTestnet => 84,
            Self::Ronin => 85,
            Self::StableTestnet => 86,
            Self::FraxtalTestnet => 87,
            Self::Abstract => 88,
            Self::FantomTestnet => 89,
            Self::Merlin => 90,
            Self::Tempo => 91,
            Self::MegaEth => 92,
            Self::MemeCore => 93,
            Self::Robinhood => 94,
            Self::Iotex => 95,
            Self::WorldSepolia => 96,
            Self::Mantle => 97,
            Self::MantleSepolia => 98,
            Self::Arc => 99,
            Self::OpBNBTestnet => 100,
            Self::MegaEthTestnet => 101,
            Self::Zeta => 102,
            Self::Canto => 103,
            Self::Kaia => 104,
            Self::Base => 105,
            Self::EvmosTestnet => 106,
            Self::Evmos => 107,
            Self::Plasma => 108,
            Self::PlasmaTestnet => 109,
            Self::MonadTestnet => 110,
            Self::Chiado => 111,
            Self::AbstractTestnet => 112,
            Self::Cannon => 113,
            Self::Immutable => 114,
            Self::ImmutableTestnet => 115,
            Self::GravityAlphaTestnetSepolia => 116,
            Self::SignetPecorino => 117,
            Self::SonicTestnet => 118,
            Self::Holesky => 119,
            Self::FluentDevnet => 120,
            Self::FluentTestnet => 121,
            Self::Fluent => 122,
            Self::Oasis => 123,
            Self::TempoDevnet => 124,
            Self::AnvilHardhat => 125,
            Self::Curtis => 126,
            Self::ApeChain => 127,
            Self::Mode => 128,
            Self::LensTestnet => 129,
            Self::Arbitrum => 130,
            Self::ArbitrumNova => 131,
            Self::Celo => 132,
            Self::EmeraldTestnet => 133,
            Self::Emerald => 134,
            Self::TempoTestnet => 135,
            Self::TempoModerato => 136,
            Self::Etherlink => 137,
            Self::AvalancheFuji => 138,
            Self::Avalanche => 139,
            Self::Formicarium => 140,
            Self::Insectarium => 141,
            Self::RobinhoodTestnet => 142,
            Self::Sophon => 143,
            Self::Superposition => 144,
            Self::Ink => 145,
            Self::PgnSepolia => 146,
            Self::LineaGoerli => 147,
            Self::LineaSepolia => 148,
            Self::Linea => 149,
            Self::Bob => 150,
            Self::Treasure => 151,
            Self::RadiusTestnet => 152,
            Self::PolygonAmoy => 153,
            Self::BerachainBepolia => 154,
            Self::Berachain => 155,
            Self::Blast => 156,
            Self::BaseGoerli => 157,
            Self::BaseSepolia => 158,
            Self::Plume => 159,
            Self::PlumeTestnet => 160,
            Self::SuperpositionTestnet => 161,
            Self::Gravity => 162,
            Self::EtherlinkShadownet => 163,
            Self::Taiko => 164,
            Self::TaikoHekla => 165,
            Self::Bitlayer => 166,
            Self::RoninTestnet => 167,
            Self::FilecoinCalibrationTestnet => 168,
            Self::ArbitrumTestnet => 169,
            Self::ArbitrumGoerli => 170,
            Self::ArbitrumSepolia => 171,
            Self::SyndrSepolia => 172,
            Self::AutonomysNovaTestnet => 173,
            Self::ScrollSepolia => 174,
            Self::Scroll => 175,
            Self::Hoodi => 176,
            Self::Xai => 177,
            Self::PharosTestnet => 178,
            Self::Radius => 179,
            Self::Katana => 180,
            Self::InkSepolia => 181,
            Self::BobSepolia => 182,
            Self::Odyssey => 183,
            Self::TreasureTopaz => 184,
            Self::ArcTestnet => 185,
            Self::Zora => 186,
            Self::CeloSepolia => 187,
            Self::Sepolia => 188,
            Self::OptimismSepolia => 189,
            Self::Corn => 190,
            Self::CornTestnet => 191,
            Self::BlastSepolia => 192,
            Self::SkaleBaseSepoliaTestnet => 193,
            Self::PolkadotTestnet => 194,
            Self::Kusama => 195,
            Self::Polkadot => 196,
            Self::SophonTestnet => 197,
            Self::Degen => 198,
            Self::ZoraSepolia => 199,
            Self::SkaleBase => 200,
            Self::Aurora => 201,
            Self::AuroraTestnet => 202,
            Self::XaiSepolia => 203,
        }
    }
...
static NATIVE_CURRENCY_SYMBOLS: [&str; 65] = [
    "ETH", "FLR", "RBTC", "tRBTC", "TLOS", "CRAB", "RING", "XDC", "TXDC", "BNB", "CFX", "C2FLR",
    "POL", "MON", "S", "SMR", "RBNT", "HAPPY", "GHO", "PLS", "WRLD", "KRING", "USDT0", "HYPE",
    "CORE", "DEV", "GLMR", "MOVR", "SEI", "INJ", "VANA", "IP", "G", "PROS", "WBT", "RON", "BTC",
    "USD", "M", "IOTX", "MNT", "USDC", "ZETA", "KAIA", "XPL", "IMX", "tIMX", "USDS", "APE",
    "GRASS", "CELO", "XTZ", "tM", "SOPH", "MAGIC", "RUSD", "BERA", "PLUME", "XAI", "PHRS", "BTCN",
    "PAS", "KSM", "DOT", "DEGEN",
];

static ETHERSCAN_API_URLS: [&str; 163] = [
    ...
    "https://explorer.testnet.whitechain.io/api",
...
static ETHERSCAN_BASE_URLS: [&str; 166] = [
    "https://etherscan.io",
    ...
    "https://explorer.testnet.whitechain.io",
...
static CHAIN_DATA: [ChainData; 204] = {
    ...
    [
        ...
        d(83, 34, 62, 62, N, 1000, S | T | O, W),
        d(84, N, 63, 63, 1, 2000, S | T | O, W),
        d(85, 35, 64, 64, N, 3000, S | O, W),
        d(86, 22, 65, 65, 0, 700, S | T, W),
        d(87, N, 66, 66, 0, 2000, S | T | O, W),
        d(88, 0, 67, 67, 0, 1000, X, 15),
        d(89, N, N, N, 3, 1200, L | T, W),
        d(90, 36, 68, 68, 7, 3000, 0, 16),
        d(91, 37, 69, 69, N, 500, S | TP, W),
        d(92, 0, 70, 70, 0, 1000, S, W),
        d(93, 38, 71, 71, 0, 7000, S, 17),
        d(94, 0, 72, 72, 0, 400, S | A, W),
        d(95, 39, N, N, N, 5000, S, 18),
        d(96, 20, 73, 73, 1, 2000, S | T | O, W),
        d(97, 40, 74, 74, 0, 2000, S, 19),
        d(98, 40, 75, 75, 0, 2000, S | T, W),
        d(99, 41, 76, 76, 0, 500, S, W),
        d(100, 9, 77, 77, 0, 1000, S | T | O, W),
        d(101, 0, 78, 78, 0, 1000, S | T, W),
        d(102, 42, 79, 79, 8, 6000, 0, 20),
        d(103, N, N, N, 1, 5700, 0, W),
        d(104, 43, 80, 80, 9, 1000, 0, 21),
        d(105, 0, 81, 81, 0, 2000, S | O, 1),
        d(106, N, N, N, N, 1900, T, W),
        d(107, N, N, N, N, 1900, 0, W),
        d(108, 44, 82, 82, 0, 1000, 0, W),
        d(109, 44, 83, 83, 0, 1000, T, W),
        d(110, 13, 84, 84, 0, 400, S | T, W),
        d(111, N, 85, 85, N, 5000, S, W),
        d(112, N, 86, 86, 0, 1000, T | X, W),
        d(113, N, N, N, N, 0, S | T, W),
        d(114, 45, 87, 87, 1, 2000, S, W),
        d(115, 46, 88, 88, 1, 2000, S | T, W),
        d(116, 32, 89, 89, N, 260, S | T, W),
        d(117, 47, 90, 90, 1, 12000, S | T, W),
        d(118, 14, 91, 91, 0, 1000, T, W),
        d(119, 0, 92, 92, 0, 0, S | T | E, W),
        d(120, N, 93, 93, N, 3000, S | T, W),
        d(121, N, 94, 94, N, 1000, S | T, W),
        d(122, N, 95, 95, N, 1000, 0, W),
        d(123, N, N, N, N, 5500, 0, W),
        d(124, 37, 69, 96, N, 500, S | T | TP, W),
        d(125, N, N, N, N, 200, S | T, W),
        d(126, 48, 96, 97, 1, 260, S | T, W),
        d(127, 48, 97, 98, 0, 260, S, 22),
        d(128, N, 98, 99, 1, 2000, S | O, W),
        d(129, 49, 99, 100, N, 1000, T | X, W),
        d(130, 0, 100, 101, 0, 260, S | A, 23),
        d(131, 0, 101, 102, 0, 260, S | A, W),
        d(132, 50, 102, 103, 0, 1000, S | O, W),
        d(133, N, 103, 104, N, 0, L | T, W),
        d(134, N, 104, 105, N, 6000, L, W),
        d(135, 37, 69, 106, N, 500, S | T | TP, W),
        d(136, 37, 69, 107, N, 500, S | T | TP, W),
        d(137, 51, 105, 108, 1, 5000, S, W),
        d(138, N, 106, 109, 0, 2000, S | T, W),
        d(139, N, 107, 110, 0, 2000, S, 24),
        d(140, 52, 108, 111, 0, 7000, S | T, 17),
        d(141, 52, 109, 112, N, 7000, S | T, 17),
        d(142, 0, 110, 113, N, 400, S | T | A, W),
        d(143, 53, 111, 114, 0, 1000, L | X, 25),
        d(144, 0, 112, 115, 1, 260, S, 26),
        d(145, 0, 113, 116, 1, 1000, S | O, W),
        d(146, N, N, N, 1, 2000, T | O, W),
        d(147, N, N, N, N, 2000, T, W),
        d(148, N, 114, 117, 0, 2000, T, W),
        d(149, 0, 115, 118, 0, 2000, S, 27),
        d(150, 0, 116, 119, N, 2000, S, W),
        d(151, 54, N, N, N, 0, L, 28),
        d(152, 55, 117, 120, N, 500, S | T, W),
        d(153, 12, 118, 121, 0, 2100, T, W),
        d(154, 56, 119, 122, 10, 2000, S | T, W),
        d(155, 56, 120, 123, 10, 2000, S, 29),
        d(156, N, 121, 124, 0, 2000, S, 30),
        d(157, 0, N, N, 0, 2000, S | T | O, W),
        d(158, 0, 122, 125, 0, 2000, S | T | O, W),
        d(159, 57, 123, 126, N, 260, S, W),
        d(160, 57, 124, 127, N, 260, S | T, W),
        d(161, 0, 125, 128, 1, 260, S | T, W),
        d(162, 32, 126, 129, N, 260, S, W),
        d(163, 51, 127, 130, 1, 5000, S | T, W),
        d(164, 0, 128, 131, 0, 12000, S, 31),
        d(165, 0, 129, 132, 0, 12000, S | T, W),
        d(166, 36, 130, 133, 11, 3000, 0, 32),
        d(167, 35, 131, 134, N, 3000, S | T | O, W),
        d(168, N, 132, 135, N, 30000, T, W),
        d(169, N, N, N, 0, 260, T | A, W),
        d(170, N, N, N, 0, 260, T | A, W),
        d(171, N, 133, 136, 0, 260, S | T | A, W),
        d(172, N, 134, 137, 0, 260, S | T, W),
        d(173, N, N, N, N, 1000, S | T, W),
        d(174, 0, 135, 138, 0, 3000, S | T, W),
        d(175, 0, 136, 139, 0, 3000, S, 33),
        d(176, N, 137, 140, 0, 0, S | T, W),
        d(177, 58, 138, 141, 0, 260, S, W),
        d(178, 59, N, N, N, 1000, S | T, W),
        d(179, 55, 139, 142, N, 500, S, W),
        d(180, 0, 140, 143, 0, 1000, S | O, W),
        d(181, N, 141, 144, 1, 1000, S | T | O, W),
        d(182, N, 142, 145, N, 2000, S | T, W),
        d(183, N, 143, 146, N, 1000, S | T | O, W),
        d(184, 54, N, N, N, 0, L | T, W),
        d(185, 41, 144, 147, 1, 500, S | T, W),
        d(186, N, 145, 148, 1, 2000, O, W),
        d(187, 50, 146, 149, 1, 1000, S | T, W),
        d(188, 0, 147, 150, 0, 0, S | T | E, W),
        d(189, 0, 148, 151, 0, 2000, S | T | O, W),
        d(190, 60, 149, 152, 2, 0, S, W),
        d(191, 60, 150, 153, 2, 0, S | T, W),
        d(192, N, 151, 154, 0, 2000, S | T | O, W),
        d(193, N, 152, 155, 1, 1000, T, W),
        d(194, 61, 153, 156, 1, 2000, S | T, W),
        d(195, 62, 154, 157, 1, 2000, S, W),
        d(196, 63, 155, 158, 1, 2000, S, W),
        d(197, 53, 156, 159, 0, 1000, L | T | X, W),
        d(198, 64, 157, 160, N, 600, 0, W),
        d(199, N, 158, 161, 1, 2000, S | T | O, W),
        d(200, N, 159, 162, 1, 1000, 0, W),
        d(201, N, 160, 163, 0, 1100, 0, W),
        d(202, N, 161, 164, 0, 1100, T, W),
        d(203, 58, 162, 165, 0, 260, S | T, W),
    ]
};
