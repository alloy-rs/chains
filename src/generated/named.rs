...
static CHAIN_DATA: [ChainData; 203] = {
    ...
    [
        ...
        d(98, 40, N, N, N, 500, S, W),
        d(99, 9, 75, 75, 0, 1000, S | T | O, W),
        d(100, 0, 76, 76, 0, 1000, S | T, W),
        d(101, 41, 77, 77, 8, 6000, 0, 20),
        d(102, N, N, N, 1, 5700, 0, W),
        d(103, 42, 78, 78, 9, 1000, 0, 21),
        d(104, 0, 79, 79, 0, 2000, S | O, 1),
        d(105, N, N, N, N, 1900, T, W),
        d(106, N, N, N, N, 1900, 0, W),
        d(107, 43, 80, 80, 0, 1000, 0, W),
        d(108, 43, 81, 81, 0, 1000, T, W),
        d(109, 13, 82, 82, 0, 400, S | T, W),
        d(110, N, 83, 83, N, 5000, S, W),
        d(111, N, 84, 84, 0, 1000, T | X, W),
        d(112, N, N, N, N, 0, S | T, W),
        d(113, 44, 85, 85, 1, 2000, S, W),
        d(114, 45, 86, 86, 1, 2000, S | T, W),
        d(115, 32, 87, 87, N, 260, S | T, W),
        d(116, 46, 88, 88, 1, 12000, S | T, W),
        d(117, 14, 89, 89, 0, 1000, T, W),
        d(118, 0, 90, 90, 0, 0, S | T | E, W),
        d(119, N, 91, 91, N, 3000, S | T, W),
        d(120, N, 92, 92, N, 1000, S | T, W),
        d(121, N, 93, 93, N, 1000, 0, W),
        d(122, N, N, N, N, 5500, 0, W),
        d(123, 36, 68, 94, N, 500, S | T | TP, W),
        d(124, N, N, N, N, 200, S | T, W),
        d(125, 47, 94, 95, 1, 260, S | T, W),
        d(126, 47, 95, 96, 0, 260, S, 22),
        d(127, N, 96, 97, 1, 2000, S | O, W),
        d(128, 48, 97, 98, N, 1000, T | X, W),
        d(129, 0, 98, 99, 0, 260, S | A, 23),
        d(130, 0, 99, 100, 0, 260, S | A, W),
        d(131, 49, 100, 101, 0, 1000, S | O, W),
        d(132, N, 101, 102, N, 0, L | T, W),
        d(133, N, 102, 103, N, 6000, L, W),
        d(134, 36, 68, 104, N, 500, S | T | TP, W),
        d(135, 36, 68, 105, N, 500, S | T | TP, W),
        d(136, 50, 103, 106, 1, 5000, S, W),
        d(137, N, 104, 107, 0, 2000, S | T, W),
        d(138, N, 105, 108, 0, 2000, S, 24),
        d(139, 51, 106, 109, 0, 7000, S | T, 17),
        d(140, 51, 107, 110, N, 7000, S | T, 17),
        d(141, 0, 108, 111, N, 400, S | T | A, W),
        d(142, 52, 109, 112, 0, 1000, L | X, 25),
        d(143, 0, 110, 113, 1, 260, S, 26),
        d(144, 0, 111, 114, 1, 1000, S | O, W),
        d(145, N, N, N, 1, 2000, T | O, W),
        d(146, N, N, N, N, 2000, T, W),
        d(147, N, 112, 115, 0, 2000, T, W),
        d(148, 0, 113, 116, 0, 2000, S, 27),
        d(149, 0, 114, 117, N, 2000, S, W),
        d(150, 53, N, N, N, 0, L, 28),
        d(151, 54, 115, 118, N, 500, S | T, W),
        d(152, 12, 116, 119, 0, 2100, T, W),
        d(153, 55, 117, 120, 10, 2000, S | T, W),
        d(154, 55, 118, 121, 10, 2000, S, 29),
        d(155, N, 119, 122, 0, 2000, S, 30),
        d(156, 0, N, N, 0, 2000, S | T | O, W),
        d(157, 0, 120, 123, 0, 2000, S | T | O, W),
        d(158, 56, 121, 124, N, 260, S, W),
        d(159, 56, 122, 125, N, 260, S | T, W),
        d(160, 0, 123, 126, 1, 260, S | T, W),
        d(161, 32, 124, 127, N, 260, S, W),
        d(162, 50, 125, 128, 1, 5000, S | T, W),
        d(163, 0, 126, 129, 0, 12000, S, 31),
        d(164, 0, 127, 130, 0, 12000, S | T, W),
        d(165, 35, 128, 131, 11, 3000, 0, 32),
        d(166, 34, 129, 132, N, 3000, S | T | O, W),
        d(167, N, 130, 133, N, 30000, T, W),
        d(168, N, N, N, 0, 260, T | A, W),
        d(169, N, N, N, 0, 260, T | A, W),
        d(170, N, 131, 134, 0, 260, S | T | A, W),
        d(171, N, 132, 135, 0, 260, S | T, W),
        d(172, N, N, N, N, 1000, S | T, W),
        d(173, 0, 133, 136, 0, 3000, S | T, W),
        d(174, 0, 134, 137, 0, 3000, S, 33),
        d(175, N, 135, 138, 0, 0, S | T, W),
        d(176, 57, 136, 139, 0, 260, S, W),
        d(177, 58, N, N, N, 1000, S | T, W),
        d(178, 54, 137, 140, N, 500, S, W),
        d(179, 0, 138, 141, 0, 1000, S | O, W),
        d(180, N, 139, 142, 1, 1000, S | T | O, W),
        d(181, N, 140, 143, N, 2000, S | T, W),
        d(182, N, 141, 144, N, 1000, S | T | O, W),
        d(183, 53, N, N, N, 0, L | T, W),
        d(184, 40, 142, 145, 1, 500, S | T, W),
        d(185, N, 143, 146, 1, 2000, O, W),
        d(186, 49, 144, 147, 1, 1000, S | T, W),
        d(187, 0, 145, 148, 0, 0, S | T | E, W),
        d(188, 0, 146, 149, 0, 2000, S | T | O, W),
        d(189, 59, 147, 150, 2, 0, S, W),
        d(190, 59, 148, 151, 2, 0, S | T, W),
        d(191, N, 149, 152, 0, 2000, S | T | O, W),
        d(192, N, 150, 153, 1, 1000, T, W),
        d(193, 60, 151, 154, 1, 2000, S | T, W),
        d(194, 61, 152, 155, 1, 2000, S, W),
        d(195, 62, 153, 156, 1, 2000, S, W),
        d(196, 52, 154, 157, 0, 1000, L | T | X, W),
        d(197, 63, 155, 158, N, 600, 0, W),
        d(198, N, 156, 159, 1, 2000, S | T | O, W),
        d(199, N, 157, 160, 1, 1000, 0, W),
        d(200, N, 158, 161, 0, 1100, 0, W),
        d(201, N, 159, 162, 0, 1100, T, W),
        d(202, 57, 160, 163, 0, 260, S | T, W),
    ]
};
