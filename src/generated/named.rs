...
impl NamedChain {
    ...
    const fn index(self) -> ChainIndex {
        match self {
            ...
            Self::Gravity => 158,
            Self::EtherlinkShadownet => 159,
            Self::Taiko => 160,
            Self::TaikoHekla => 161,
            Self::Bitlayer => 162,
            Self::RoninTestnet => 163,
            Self::FilecoinCalibrationTestnet => 164,
            Self::ArbitrumTestnet => 165,
            Self::ArbitrumGoerli => 166,
            Self::ArbitrumSepolia => 167,
            Self::SyndrSepolia => 168,
            Self::AutonomysNovaTestnet => 169,
            Self::ScrollSepolia => 170,
            Self::Scroll => 171,
            Self::Hoodi => 172,
            Self::Xai => 173,
            Self::PharosTestnet => 174,
            Self::Radius => 175,
            Self::Katana => 176,
            Self::InkSepolia => 177,
            Self::BobSepolia => 178,
            Self::Odyssey => 179,
            Self::TreasureTopaz => 180,
            Self::ArcTestnet => 181,
            Self::Zora => 182,
            Self::CeloSepolia => 183,
            Self::Sepolia => 184,
            Self::OptimismSepolia => 185,
            Self::Corn => 186,
            Self::CornTestnet => 187,
            Self::BlastSepolia => 188,
            Self::SkaleBaseSepoliaTestnet => 189,
            Self::PolkadotTestnet => 190,
            Self::Kusama => 191,
            Self::Polkadot => 192,
            Self::SophonTestnet => 193,
            Self::Degen => 194,
            Self::ZoraSepolia => 195,
            Self::SkaleBase => 196,
            Self::Aurora => 197,
            Self::AuroraTestnet => 198,
            Self::XaiSepolia => 199,
        }
    }
...
static WRAPPED_NATIVE_TOKENS: [Address; 33] = [
...
static CHAIN_DATA: [ChainData; 200] = {
    ...
    [
        ...
        d(142, 0, 110, 113, 1, 1000, S | O, W),
        d(143, N, N, N, 1, 2000, T | O, W),
        d(144, N, N, N, N, 2000, T, W),
        d(145, N, 111, 114, 0, 2000, T, W),
        d(146, 0, 112, 115, 0, 2000, S, 26),
        d(147, 0, 113, 116, N, 2000, S, W),
        d(148, 52, N, N, N, 0, L, 27),
        d(149, 53, 114, 117, N, 500, S | T, W),
        d(150, 12, 115, 118, 0, 2100, T, W),
        d(151, 54, 116, 119, 10, 2000, S | T, W),
        d(152, 54, 117, 120, 10, 2000, S, 28),
        d(153, N, 118, 121, 0, 2000, S, 29),
        d(154, 0, N, N, 0, 2000, S | T | O, W),
        d(155, 0, 119, 122, 0, 2000, S | T | O, W),
        d(156, 55, 120, 123, N, 260, S, W),
        d(157, 55, 121, 124, N, 260, S | T, W),
        d(158, 32, 122, 125, N, 260, S, W),
        d(159, 49, 123, 126, 1, 5000, S | T, W),
        d(160, 0, 124, 127, 0, 12000, S, 30),
        d(161, 0, 125, 128, 0, 12000, S | T, W),
        d(162, 35, 126, 129, 11, 3000, 0, 31),
        d(163, 34, 127, 130, N, 3000, S | T | O, W),
        d(164, N, 128, 131, N, 30000, T, W),
        d(165, N, N, N, 0, 260, T | A, W),
        d(166, N, N, N, 0, 260, T | A, W),
        d(167, N, 129, 132, 0, 260, S | T | A, W),
        d(168, N, 130, 133, 0, 260, S | T, W),
        d(169, N, N, N, N, 1000, S | T, W),
        d(170, 0, 131, 134, 0, 3000, S | T, W),
        d(171, 0, 132, 135, 0, 3000, S, 32),
        d(172, N, 133, 136, 0, 0, S | T, W),
        d(173, 56, 134, 137, 0, 260, S, W),
        d(174, 57, N, N, N, 1000, S | T, W),
        d(175, 53, 135, 138, N, 500, S, W),
        d(176, 0, 136, 139, 0, 1000, S | O, W),
        d(177, N, 137, 140, 1, 1000, S | T | O, W),
        d(178, N, 138, 141, N, 2000, S | T, W),
        d(179, N, 139, 142, N, 1000, S | T | O, W),
        d(180, 52, N, N, N, 0, L | T, W),
        d(181, 58, 140, 143, 1, 500, S | T, W),
        d(182, N, 141, 144, 1, 2000, O, W),
        d(183, 48, 142, 145, 1, 1000, S | T, W),
        d(184, 0, 143, 146, 0, 0, S | T | E, W),
        d(185, 0, 144, 147, 0, 2000, S | T | O, W),
        d(186, 59, 145, 148, 2, 0, S, W),
        d(187, 59, 146, 149, 2, 0, S | T, W),
        d(188, N, 147, 150, 0, 2000, S | T | O, W),
        d(189, N, 148, 151, 1, 1000, T, W),
        d(190, 60, 149, 152, 1, 2000, S | T, W),
        d(191, 61, 150, 153, 1, 2000, S, W),
        d(192, 62, 151, 154, 1, 2000, S, W),
        d(193, 51, 152, 155, 0, 1000, L | T | X, W),
        d(194, 63, 153, 156, N, 600, 0, W),
        d(195, N, 154, 157, 1, 2000, S | T | O, W),
        d(196, N, 155, 158, 1, 1000, 0, W),
        d(197, N, 156, 159, 0, 1100, 0, W),
        d(198, N, 157, 160, 0, 1100, T, W),
        d(199, 56, 158, 161, 0, 260, S | T, W),
    ]
};
