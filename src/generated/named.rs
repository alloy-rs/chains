...
static CHAIN_DATA: [ChainData; 201] = {
    ...
    [
        ...
        d(79, 33, 60, 60, N, 1000, S, W),
        d(80, 29, 61, 61, 1, 700, S, W),
        d(81, N, 62, 62, 1, 2000, S | O, W),
        d(82, N, 63, 63, 1, 2000, S | T | O, W),
        d(83, 34, 64, 64, N, 3000, 0, W),
        d(84, 22, 65, 65, 0, 700, S | T, W),
        d(85, N, 66, 66, 0, 2000, S | T | O, W),
        d(86, 0, 67, 67, 0, 1000, X, 15),
        d(87, N, N, N, 3, 1200, L | T, W),
        d(88, 35, 68, 68, 7, 3000, 0, 16),
        d(89, 36, 69, 69, N, 500, S | TP, W),
        d(90, 0, 70, 70, 0, 1000, S, W),
        d(91, 37, 71, 71, 0, 7000, S, 17),
        d(92, 0, 72, 72, N, 400, S | A, W),
        d(93, 38, N, N, N, 5000, S, 18),
        d(94, 20, 73, 73, 1, 2000, S | T | O, W),
        d(95, 39, 74, 74, 0, 2000, S, 19),
        d(96, 39, 75, 75, 0, 2000, S | T, W),
        d(97, 9, 76, 76, 0, 1000, S | T | O, W),
        d(98, 0, 77, 77, 0, 1000, S | T, W),
        d(99, 40, 78, 78, 8, 6000, 0, 20),
        d(100, N, N, N, 1, 5700, 0, W),
        d(101, 41, 79, 79, 9, 1000, 0, 21),
        d(102, 0, 80, 80, 0, 2000, S | O, 1),
        d(103, N, N, N, N, 1900, T, W),
        d(104, N, N, N, N, 1900, 0, W),
        d(105, 42, 81, 81, 0, 1000, 0, W),
        d(106, 42, 82, 82, 0, 1000, T, W),
        d(107, 13, 83, 83, 0, 400, S | T, W),
        d(108, N, 84, 84, N, 5000, S, W),
        d(109, N, 85, 85, 0, 1000, T | X, W),
        d(110, N, N, N, N, 0, S | T, W),
        d(111, 43, 86, 86, 1, 2000, S, W),
        d(112, 44, 87, 87, 1, 2000, S | T, W),
        d(113, 32, 88, 88, N, 260, S | T, W),
        d(114, 45, 89, 89, 1, 12000, S | T, W),
        d(115, 14, 90, 90, 0, 1000, T, W),
        d(116, 0, 91, 91, 0, 0, S | T | E, W),
        d(117, N, 92, 92, N, 3000, S | T, W),
        d(118, N, 93, 93, N, 1000, S | T, W),
        d(119, N, 94, 94, N, 1000, 0, W),
        d(120, N, N, N, N, 5500, 0, W),
        d(121, 36, N, N, N, 500, S | T | TP, W),
        d(122, N, N, N, N, 200, S | T, W),
        d(123, 46, 95, 95, 1, 260, S | T, W),
        d(124, 46, 96, 96, 0, 260, S, 22),
        d(125, N, 97, 97, 1, 2000, S | O, W),
        d(126, 47, 98, 98, N, 1000, T | X, W),
        d(127, 0, 99, 99, 0, 260, S | A, 23),
        d(128, 0, 100, 100, 0, 260, S | A, W),
        d(129, 48, 101, 101, 0, 1000, S | O, W),
        d(130, N, 102, 102, N, 0, L | T, W),
        d(131, N, 103, 103, N, 6000, L, W),
        d(132, 36, 69, 104, N, 500, S | T | TP, W),
        d(133, 36, 69, 105, N, 500, S | T | TP, W),
        d(134, 49, 104, 106, 1, 5000, S, W),
        d(135, N, 105, 107, 0, 2000, S | T, W),
        d(136, N, 106, 108, 0, 2000, S, 24),
        d(137, 50, 107, 109, 0, 7000, S | T, 17),
        d(138, 50, 108, 110, N, 7000, S | T, 17),
        d(139, 0, 109, 111, N, 400, S | T | A, W),
        d(140, 51, 110, 112, 0, 1000, L | X, 25),
        d(141, 0, 111, 113, 1, 260, S, 26),
        d(142, 0, 112, 114, 1, 1000, S | O, W),
        d(143, N, N, N, 1, 2000, T | O, W),
        d(144, N, N, N, N, 2000, T, W),
        d(145, N, 113, 115, 0, 2000, T, W),
        d(146, 0, 114, 116, 0, 2000, S, 27),
        d(147, 0, 115, 117, N, 2000, S, W),
        d(148, 52, N, N, N, 0, L, 28),
        d(149, 53, 116, 118, N, 500, S | T, W),
        d(150, 12, 117, 119, 0, 2100, T, W),
        d(151, 54, 118, 120, 10, 2000, S | T, W),
        d(152, 54, 119, 121, 10, 2000, S, 29),
        d(153, N, 120, 122, 0, 2000, S, 30),
        d(154, 0, N, N, 0, 2000, S | T | O, W),
        d(155, 0, 121, 123, 0, 2000, S | T | O, W),
        d(156, 55, 122, 124, N, 260, S, W),
        d(157, 55, 123, 125, N, 260, S | T, W),
        d(158, 0, 124, 126, 1, 260, S | T, W),
        d(159, 32, 125, 127, N, 260, S, W),
        d(160, 49, 126, 128, 1, 5000, S | T, W),
        d(161, 0, 127, 129, 0, 12000, S, 31),
        d(162, 0, 128, 130, 0, 12000, S | T, W),
        d(163, 35, 129, 131, 11, 3000, 0, 32),
        d(164, 34, 130, 132, N, 3000, T, W),
        d(165, N, 131, 133, N, 30000, T, W),
        d(166, N, N, N, 0, 260, T | A, W),
        d(167, N, N, N, 0, 260, T | A, W),
        d(168, N, 132, 134, 0, 260, S | T | A, W),
        d(169, N, 133, 135, 0, 260, S | T, W),
        d(170, N, N, N, N, 1000, S | T, W),
        d(171, 0, 134, 136, 0, 3000, S | T, W),
        d(172, 0, 135, 137, 0, 3000, S, 33),
        d(173, N, 136, 138, 0, 0, S | T, W),
        d(174, 56, 137, 139, 0, 260, S, W),
        d(175, 57, 138, 140, N, 1000, S | T, W),
        d(176, 53, 139, 141, N, 500, S, W),
        d(177, 0, 140, 142, 0, 1000, S | O, W),
        d(178, N, 141, 143, 1, 1000, S | T | O, W),
        d(179, N, 142, 144, N, 2000, S | T, W),
        d(180, N, 143, 145, N, 1000, S | T | O, W),
        d(181, 52, N, N, N, 0, L | T, W),
        d(182, 58, 144, 146, 1, 500, S | T, W),
        d(183, N, 145, 147, 1, 2000, O, W),
        d(184, 48, 146, 148, 1, 1000, S | T, W),
        d(185, 0, 147, 149, 0, 0, S | T | E, W),
        d(186, 0, 148, 150, 0, 2000, S | T | O, W),
        d(187, 59, 149, 151, 2, 0, S, W),
        d(188, 59, 150, 152, 2, 0, S | T, W),
        d(189, N, 151, 153, 0, 2000, S | T | O, W),
        d(190, N, 152, 154, 1, 1000, T, W),
        d(191, 60, 153, 155, 1, 2000, S | T, W),
        d(192, 61, 154, 156, 1, 2000, S, W),
        d(193, 62, 155, 157, 1, 2000, S, W),
        d(194, 51, 156, 158, 0, 1000, L | T | X, W),
        d(195, 63, 157, 159, N, 600, 0, W),
        d(196, N, 158, 160, 1, 2000, S | T | O, W),
        d(197, N, 159, 161, 1, 1000, 0, W),
        d(198, N, 160, 162, 0, 1100, 0, W),
        d(199, N, 161, 163, 0, 1100, T, W),
        d(200, 56, 162, 164, 0, 260, S | T, W),
    ]
};
