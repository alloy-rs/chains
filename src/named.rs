...
impl NamedChain {
    ...
    pub const fn verifier_urls(self) -> Option<Vec<(VerifierType, &'static str, &'static str)>> {
        ...
        Some(match self {
            ...
            Cfx => vec![(
                VerifierType::Custom("Conflux Scan"),
            ...
            Kaia => vec![(
                VerifierType::Custom("Bisonai"),
                "https://mainnet-oapi.kaiascan.io/api",
                "https://kaiascan.io",
            )],
            Story => vec![(
                VerifierType::Blockscout,
                "https://www.storyscan.xyz/api/v2",
