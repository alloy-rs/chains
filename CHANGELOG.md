...
- [deps] Bump the ci-weekly group across 1 directory with 3 updates ([#311](https://github.com/alloy-rs/chains/issues/311))
- [deps] Bump the ci-weekly group with 2 updates ([#309](https://github.com/alloy-rs/chains/issues/309))
...
- [deps] Bump the ci-weekly group with 2 updates ([#306](https://github.com/alloy-rs/chains/issues/306))

### Features

- Add Pharos mainnet and testnet ([#307](https://github.com/alloy-rs/chains/issues/307))
